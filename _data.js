...
export const seed = {
  ...
  principalMessage:'Principal of Sri Vidya E.M. School. The website presents the school leadership with the official supplied photograph and school branding.', principalImage:'/images/principal-designed.png',
...
function normalizeGallery(items){
  ...
  const result=items.filter(Boolean).map((item,i)=>{
    ...
    if(isPrincipal)return{src:'/images/principal-designed.png',title:item.title||'Principal',cat:'Principal'};
